...
const NormalComponent = () => {
    return (
        <div style={{ border: '2px solid black' }}>
            ...
            <img width="50%" height="200px" src="https://pbs.twimg.com/media/DOzL82mXkAA0zFs.jpg" alt=""/>
        </div>
    );
};
...
const CreateElementComponent = () => {
    return (
        React.createElement('div', { style: { border: '2px solid black' } },
            ...
            React.createElement('p', null, 'This was consntructed with CreateElement calls in the return.'),
